...
\begin{document}
    ...
    \begin{exercise}
        \begin{enumerate}
            ...
            % La respuesta a la pregunta anterior es que la curvatura del espacio-tiempo es intrínseca, ya que por definición (o convención), no hay un espacio de mayor dimensionalidad que el espacio-tiempo que conocemos.
